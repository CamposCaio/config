...
static const char *xfcecmd[]  			= { "xfce4-terminal", NULL };
...
static Key keys[] = {
	...
	{ ShiftMask, 				XK_Print, 					spawn, {.v = shotnow } },
	{ ControlMask, 				XK_Print, 					spawn, {.v = shotwin } },
	{ ALTKEY|ControlMask, 		XK_Print, 					spawn, {.v = shotin10 } },

	// Terminals -----------
    { MODKEY, 					XK_Return, 					spawn, {.v = xfcecmd } },
